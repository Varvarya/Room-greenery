...
router.delete('/id/:id', [authJwt.verifyToken, authJwt.isAdminOrModer], speciesController.deleteById);
router.delete('/name/:species', [authJwt.verifyToken, authJwt.isAdminOrModer], speciesController.deleteByName);
